"""
Django settings for HiveAmc project.
...
SECRET_KEY = 'django-insecure-$zc+3=3dw@5*+pmj@non#(!&b3n)bc)q+_g4w2%8aq5f&go^l+'
...
WSGI_APPLICATION = 'HiveAmc.wsgi.application'
